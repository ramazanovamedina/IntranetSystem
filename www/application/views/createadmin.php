...
<form action="" method="post" class="form-horizontal">
	<fieldset>
    <legend>Регистрация пользователя - администратор</legend>
	<?php if(isset($ok)){?><div class="alert alert-success">Пользователь зарегистрирован</div><?php } ?>
		<table>
			...
			<tr>
				...
				<?php if(isset($empty_address)){ ?><td><div class="alert alert-error">Поле Адрес, телефон, эл.почта должно быть заполнено</td></td><?php } ?>
			</tr>
			<tr>
				<td>Документы:</td>
