	...
	<body>
		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="nav">
					<li><a href="<?php echo URL::site('parent'); ?>">Главная</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Расписание<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL::site('schedule/student_schedule/'.$student_id); ?>">Расписание ребенка</a></li>
					...
					<li><a href="<?php echo URL::site('dnevnik/dnevnik'); ?>">Дневник</a></li>
					
					<li><a href="<?php echo URL::site('attendance/attendance'); ?>">Пропуски</a></li>
					
					<li><a href="<?php echo URL::site('mymarks/marks'); ?>">Оценки</a></li>
					...
					<li><a href="<?php echo URL::site('intranetnews/view'); ?>">Новости</a></li>
