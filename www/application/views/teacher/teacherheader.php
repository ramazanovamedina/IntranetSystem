	...
	<body>
		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="nav">
					<li><a href="<?php echo URL::site('teacher'); ?>">Главная</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Расписание<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL::site('schedule/teacher_schedule/'.$user_id); ?>">Мое расписание</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL::site('filljurnal/fill_jurnal'); ?>">Заполнить журнал</a></li>
						</ul>
					</li>
					
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Домашнее задание<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL::site('homework/homework'); ?>">Задать</a></li>
						</ul>
					</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL::site('files/view?dir='.'C:/xampp/htdocs/intranet/www/public/uploads/'.$user_id); ?>">Мои файлы</a></li>
						</ul>
					</li>
