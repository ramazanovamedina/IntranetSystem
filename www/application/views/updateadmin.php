...
<script type = "text/javascript">
	...
	$(function() {
		$("button#submit").click(function(){
			var sel = $("#admins").text();
			$.post("/ajax/deleteadmin", {admin:sel});
			$("#example").modal('hide');
			location.href = "/adminprof/update_user";
		});
	});
</script>
</head>
...
<form action="" method="post" class="form-horizontal">
	<fieldset>
    <legend>Обновление пользователя - администратор</legend>
	<div class="alert alert-info" id = "admins"><?php echo $usname; ?></div>
	...
	<input type = "text" name = "secret" style = "display:none" value="<?php echo $qid; ?>">
			<table>
				...
				<?php if(isset($empty_date_of_birth)){ ?><td><div class="alert alert-error">Поле Дата рождения должно быть заполнено</td></td><?php } ?>			
			</tr>
			<tr>
