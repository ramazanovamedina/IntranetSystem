...
<script type = "text/javascript">
	...
	$(function() {
		$("button#submit").click(function(){
			var sel = $("#students").text();
			$.post("/ajax/deletestudent", {student:sel});
			$("#example").modal('hide');
			location.href = "/studentprof/update_user";
		});
	});
</script>
</head>
...
<form action="" method="post" class="form-horizontal">
	<fieldset>
    <legend>Обновление пользователя - ученик</legend>
	<div class="alert alert-info" id = "students"><?php echo $usname; ?></div>
	...
	<input type = "text" name = "secret" style = "display:none" value="<?php echo $qid; ?>">
			<table>
				<tr>
					<td>ФИО:</td>
					<td><input type="text" name="full_name" value="<?php echo $name ?>" class = "input-xxlarge"></td>
			...
			<tr>
				<td>Класс:</td>
				<td><select name="class" id="class" class = "input-medium">
				...
				<?php if(isset($empty_class)){ ?><td><div class="alert alert-error">Поле Класс должно быть заполнено</div></td><?php } ?> 
			</tr>
		</table>
	</fieldset>
